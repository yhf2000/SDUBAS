...
privilege_dict['/projects//contents//submissions'] = '项目提交'
privilege_dict['/projects//contents//scores'] = '项目批阅'
privilege_dict['/projects//contents//submit'] = '项目提交'
...
privilege_dict['/projects//user/score/all'] = '项目学分认定'
privilege_dict['/projects/content///score/all'] = '项目学分认定'
