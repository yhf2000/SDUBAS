...
privilege_dict['/projects/submissions//contents/'] = '项目提交'
privilege_dict['/projects/scores//contents/'] = '项目编辑'
privilege_dict['/projects/submit//contents/'] = '项目提交'
privilege_dict['/projects/members/'] = '项目查看'
privilege_dict['/projects/progress/'] = '项目查看'
privilege_dict['/projects/score/'] = '项目查看'
...
privilege_dict['/projects//user/score/all'] = '项目编辑'
privilege_dict['/projects/content///score/all'] = '项目编辑'
privilege_dict['/resources/resource'] = '添加资源'
...
privilege_dict['/resources/resource//apply/get'] = '资源审批'
...
privilege_dict['/users/user_add_batch'] = '添加用户'
