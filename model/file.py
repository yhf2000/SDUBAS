...
class Servers(Base):  # 服务器表
    ...
    server_name = Column(String(128), nullable=False, comment='服务器名称')
    ip_address = Column(String(128), nullable=False, comment='服务器的IP地址')
    location = Column(String(128), nullable=False, comment='服务器的位置')
